...
func TestBroadcast1(t *testing.T) {
	...
	br_a := a.Broadcast(2, 3, 2, 3).MustAssert()
...
func TestBroadcast3(t *testing.T) {
	...
	br_c := c.Broadcast(2, 3, 2).MustAssert()
...
func TestBroadcast4(t *testing.T) {
	...
	br_d := d.Broadcast(3, 3, 1, 2).MustAssert()
...
func TestBroadcast5(t *testing.T) {
	...
	br_d := d.Broadcast(3, 4, 1, 1, 3).MustAssert()
	data := []int32{
